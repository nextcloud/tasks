OC.L10N.register(
    ...
    "Set a reminder at a custom date and time:" : "Définir un rappel à une date et une heure personnalisées.",
    "Cancel" : "Annuler",
    "This is a todo reminder." : "Ceci est un rappel de tâche à faire",
    ...
    "Before the task starts" : "Avant le début de la tâche",
    "Before the task is due" : "Avant l'échéance de la tâche",
    "Select date and time" : "Sélectionner la date et l'heure",
    "Go back" : "Revenir en arrière",
    "Do you want to keep related reminders?" : "Souhaitez-vous conserver les rappels associés ?",
    "Discard reminders" : "Supprimer les rappels",
    "Keep reminders" : "Conserver les rappels",
    "Set a reminder relative to your tasks start date:" : "Définir un rappel par rapport au début de la tâche :",
    "Set a reminder relative to your tasks due date:" : "Définir un rappel par rapport à l'échéance de la tâche :",
    "before at" : "avant",
    ...
    "Every {interval} {frequency}" : "Tous les {interval} {frequency}",
    "on {days}" : "le {days}",
    ...
    "Task is recurring" : "La tâche est récurrente",
    ...
    "_Task has one reminder_::_Task has {n} reminders_" : ["Cette tâche a un rappel","Cette tâche a {n} rappels ","Cette tâche a {n} rappels"],
    ...
    "Tomorrow" : "Demain",
    "An error occurred, unable to create the list." : "Une erreur est survenue, impossible de créer la liste.",
    ...
    "December" : "Décembre",
    "on day {days}" : "le {days}",
    "on the {ordinal} {dayNames}" : "le {ordinal} {dayNames}",
    "in {months}" : "en {months}",
    "_{count} time_::_{count} times_" : ["{count} fois","{count} fois","{count} fois"],
    "Completion date must be in the past." : "La date d'achèvement doit être dans le passé",
    "Successfully created the task." : "Tâche créée avec succès.",
    "Successfully duplicated the task." : "La tâche a bien été dupliquée.",
    "Could not duplicate the task." : "Impossible de dupliquer la tâche.",
    ...
    "Error processing recurring task" : "Erreur lors du traitement de la tâche récurrente",
    ...
    "[Started yesterday at] LT" : "[Commencée hier à] LT",
    "[Started on] LL [at] LT" : "[Débuté le] LL [à] LT",
    "Midnight on the day the task starts" : "Dès minuit le jour où débute la tâche",
    "_%n day before the task at {formattedHourMinute}_::_%n days before the task at {formattedHourMinute}_" : ["Un jour avant le début de la tâche à {formattedHourMinute}","%n jours avant le début de la tâche à {formattedHourMinute}","%n jours avant le début de la tâche à {formattedHourMinute}"],
    "_%n week before the task at {formattedHourMinute}_::_%n weeks before the task at {formattedHourMinute}_" : ["La semaine précédent le début de la tâche à {formattedHourMinute}","%n semaines avant le début de la tâche à {formattedHourMinute}","%n semaines avant le début de la tâche à {formattedHourMinute}"],
    "on the day of the task at {formattedHourMinute}" : "le jour de la tâche à {formattedHourMinute}",
    "at the task's start" : "au début de la tâche",
    "when the task is due" : "quand la tâche doit être terminée",
    "{time} before the task starts" : "{time} avant le début de la tâche",
    "{time} before the task is due" : "{time} avant l'échéance de la tâche",
    "{time} after the task starts" : "{time} après le début de la tâche",
    "{time} after the task is due" : "{time} après l'échéance de la tâche"
},
