OC.L10N.register(
    ...
    "Deleted all completed tasks from calendar \"{calendarName}\"." : "Supprimer toutes les tâches terminées de l'agenda \"{calendarName}\".",
