OC.L10N.register(
    ...
    "Select to end repeat" : "Sélectionner pour arrêter la répétition",
    ...
    "Monthly" : "Mensuel",
    "Yearly" : "Annuel",
    "The recurrence definition of this task is not fully supported by Nextcloud. If you edit the recurrence-options, certain recurrences may be lost." : "La définition de récurrence de cette tâche n'est pas entièrement prise en charge par Nextcloud. Si vous modifiez les options de récurrence, certaines répétitions peuvent être perdues.",
    "This task is the recurrence-exception of a recurrence-set. You cannot add a recurrence-rule to it." : "Cette tâche est l'exception de récurrence d'un ensemble de récurrence. Vous ne pouvez pas lui ajouter de règle de récurrence.",
