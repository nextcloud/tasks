OC.L10N.register(
    ...
    "Loading the completed tasks of all lists might slow down the app." : "Att ladda de slutförda uppgifterna i alla listor kan sakta ner appen.",
    "Load the completed tasks of list \"{calendar}\"." : "Ladda de slutförda uppgifterna i listan \"{calendar}\".",
    "Loading the completed tasks might slow down the app." : "Att ladda de slutförda uppgifterna kan sakta ner appen.",
    ...
    "Completion date must be in the past." : "Slutdatum måste vara i det förflutna.",
