...
"Current" => "Obecny",
"Completed" => "Ukończono",
"found in task title." => "znalezione w tytue zadania",
"found in task note." => "znalezione w notatce zadania",
"found in task location." => "znalezione w lokalizacji zadania",
"found in task categories." => "znalezione w kategoriach zadania",
"found in task comments." => "znalezione w komentarzach zadania",
...
"Completed Task" => "Zadanie ukończone",
"%n Completed Task::%n Completed Tasks" => array("%n zakończone zadanie","%n zakończonych zadań","%n zakończonych zadań"),
