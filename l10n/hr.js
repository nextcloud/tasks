OC.L10N.register(
    ...
    "Once enabled, a new Tasks menu will appear in your Nextcloud apps menu. From there you can add and delete tasks, edit their title, description, start and due dates and mark them as important. Tasks can be shared between users. Tasks can be synchronized using CalDav (each task list is linked to an Nextcloud calendar, to sync it to your local client: Thunderbird, Evolution, KDE Kontact, iCal … - just add the calendar as a remote calendar in your client). You can download your tasks as ICS files using the download button for each calendar." : "Jednom kada se omogući, u izborniku aplikacija Nextclouda pojavit će se novi izbornik Zadaci. Ondje možete dodavati i brisati zadatke, uređivati njihov naslov, opis, datume početka i roka te ih označavati kao važne. Zadatke je moguće dijeliti među korisnicima. Zadatke je moguće sinkronizirati putem CalDAV-a (svaki popis zadataka povezan je s Nextcloud kalendarom; kako biste ga sinkronizirali s lokalnim klijentom — Thunderbird, Evolution, KDE Kontact, iCal… — jednostavno dodajte kalendar kao udaljeni kalendar u svom klijentu). Zadatke možete preuzeti kao ICS datoteke pomoću gumba za preuzimanje za svaki kalendar.",
    "Hidden" : "Skriveno",
    "Visible" : "Vidljivo",
    "Automatic" : "Automatsko",
    "Tasks settings" : "Postavke zadataka",
    ...
    "_Shared with {num} entity_::_Shared with {num} entities_" : ["Dijeljeno s {num} stavkom","Dijeljeno s {num} stavke","Dijeljeno s {num} stavki"],
    "Share this calendar" : "Dijeli ovaj kalendar",
    "Share this list" : "Dijeli ovaj popis",
    ...
    "Untitled journal" : "Dnevnik bez naslova",
    ...
    "Create reminder" : "Stvori podsjetnik",
    "Update reminder" : "Ažuriraj podsjetnik",
    "Set a reminder at a custom date and time:" : "Postavi podsjetnik na prilagođeni datum i vrijeme:",
    "Cancel" : "Odustani",
    "This is a todo reminder." : "Ovo je podsjetnik za zadatak.",
    ...
    "Before the task starts" : "Prije početka zadatka",
    "Before the task is due" : "Prije isteka roka zadatka",
    "Select date and time" : "Odaberite datum i vrijeme",
    "Go back" : "Natrag",
    "Do you want to keep related reminders?" : "Želite li zadržati povezane podsjetnike?",
    "Discard reminders" : "Odbaci podsjetnike",
    "Keep reminders" : "Zadrži podsjetnike",
    "Set a reminder relative to your tasks start date:" : "Postavi podsjetnik u odnosu na datum početka zadatka:",
    "Set a reminder relative to your tasks due date:" : "Postavi podsjetnik u odnosu na rok zadatka:",
    "before at" : "prije u",
    ...
    "No calendar matches the search." : "Nijedan kalendar ne odgovara pretraživanju.",
    ...
    "Every {interval} {frequency}" : "Svakih {interval} {frequency}",
    "on {days}" : "u {days}",
    "until {date}" : "do {date}",
    "{count} times" : "{count} puta",
    "Monday" : "Ponedjeljak",
    "Tuesday" : "Utorak",
    "Wednesday" : "Srijeda",
    "Thursday" : "Četvrtak",
    ...
    "{numberOfTasks} tasks have been added to \"{calendar}\"" : "Dodano je {numberOfTasks} zadataka u \"{calendar}\"",
    "Create new tasks" : "Stvori nove zadatke",
    "Create {numberOfTasks} tasks from pasted text" : "Stvori {numberOfTasks} zadataka iz zalijepljenog teksta",
    "Create tasks" : "Stvori zadatke",
    "Creating new tasks…" : "Stvaranje novih zadataka…",
    "Close" : "Zatvori",
    ...
    "Load the completed tasks of all lists." : "Učitaj dovršene zadatke sa svih popisa.",
    "Loading the completed tasks of all lists might slow down the app." : "Učitavanje dovršenih zadataka sa svih popisa može usporiti aplikaciju.",
    "Load the completed tasks of list \"{calendar}\"." : "Učitaj dovršene zadatke s popisa \"{calendar}\".",
    "Loading the completed tasks might slow down the app." : "Učitavanje dovršenih zadataka može usporiti aplikaciju.",
    ...
    "Sort by start date, priority and summary." : "Razvrstaj po datumu početka, prioritetu i sažetku.",
    "Due date" : "Datum dospijeća",
    "Sort by due date, priority and summary." : "Razvrstaj po roku, prioritetu i sažetku.",
    "Created date" : "Datum stvaranja",
    "Sort by created date, priority and summary." : "Razvrstaj po datumu stvaranja, prioritetu i sažetku.",
    "Last modified" : "Posljednja izmjena",
    "Sort by last-modified date, priority and summary." : "Razvrstaj po datumu zadnje izmjene, prioritetu i sažetku.",
    "Completed date" : "Datum završetka",
    "Sort by completed date, priority and summary." : "Razvrstaj po datumu dovršetka, prioritetu i sažetku.",
    "Priority" : "Prioritet",
    ...
    "Tags" : "Oznake",
    "Sort by tags." : "Razvrstaj po oznakama.",
    "Manually" : "Ručno",
    ...
    "Task is recurring" : "Zadatak se ponavlja",
    ...
    "Duplicate task" : "Dupliciraj zadatak",
    "Delete task" : "Izbriši zadatak",
    "Toggle starred" : "Uključi/isključi zvjezdicu",
    "_Task has one reminder_::_Task has {n} reminders_" : ["Zadatak ima jedan podsjetnik","Zadatak ima {n} podsjetnika","Zadatak ima {n} podsjetnika"],
    ...
    "Task is cancelled" : "Zadatak je otkazan",
    "Task is completed" : "Zadatak je završen",
    "Task is read-only" : "Zadatak je samo za čitanje",
    "Task is not completed" : "Zadatak nije dovršen",
    ...
    "Tomorrow" : "Sutra",
    "An error occurred, unable to create the list." : "Došlo je do pogreške, nije moguće stvoriti popis.",
    ...
    "Show in Deck" : "Prikaži u Decku",
    "Edit summary" : "Uredi sažetak",
    "Details" : "Pojedinosti",
    "Selecting a classification is forbidden, because the task was shared with you." : "Odabir klasifikacije nije dopušten jer je zadatak podijeljen s vama.",
    "Select a classification" : "Odaberi klasifikaciju",
    "Select a status" : "Odaberi status",
    "Set a location" : "Postavi lokaciju",
    "Set a URL" : "Postavi URL",
    ...
    "November" : "Studeni",
    "December" : "Prosinac",
    "on day {days}" : "na dan {days}",
    "on the {ordinal} {dayNames}" : "na {ordinal} {dayNames}",
    "in {months}" : "u {months}",
    "_{count} time_::_{count} times_" : ["{count} put","{count} puta","{count} puta"],
    "Completion date must be in the past." : "Datum dovršetka mora biti u prošlosti.",
    "Successfully created the task." : "Zadatak je uspješno stvoren.",
    "Successfully duplicated the task." : "Zadatak je uspješno dupliciran.",
    "Could not duplicate the task." : "Dupliciranje zadatka nije uspjelo.",
    ...
    "Error processing recurring task" : "Obrada ponavljajućeg zadatka nije uspjela",
    ...
    "Midnight on the day the task starts" : "Ponoć na dan početka zadatka",
    "_%n day before the task at {formattedHourMinute}_::_%n days before the task at {formattedHourMinute}_" : ["%n dan prije zadatka u {formattedHourMinute}","%n dana prije zadatka u {formattedHourMinute}","%n dana prije zadatka u {formattedHourMinute}"],
    "_%n week before the task at {formattedHourMinute}_::_%n weeks before the task at {formattedHourMinute}_" : ["%n tjedan prije zadatka u {formattedHourMinute}","%n tjedna prije zadatka u {formattedHourMinute}","%n tjedana prije zadatka u {formattedHourMinute}"],
    "on the day of the task at {formattedHourMinute}" : "na dan zadatka u {formattedHourMinute}",
    "at the task's start" : "na početku zadatka",
    "when the task is due" : "kad zadatak dospije",
    "{time} before the task starts" : "{time} prije početka zadatka",
    "{time} before the task is due" : "{time} prije isteka roka zadatka",
    "{time} after the task starts" : "{time} nakon početka zadatka",
    "{time} after the task is due" : "{time} nakon isteka roka zadatka"
},
