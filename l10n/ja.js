OC.L10N.register(
    ...
    "_year_::_years_" : ["年"],
    "Save" : "保存する",
    "Create new tasks" : "新規タスクを作成",
    "Create tasks" : "タスクを作成",
    "Creating new tasks…" : "新規タスクを作成中...",
    "Close" : "閉じる",
    ...
    "November" : "11月",
    "December" : "12月",
    "_{count} time_::_{count} times_" : ["{count}回"],
    ...
    "Task successfully moved to new calendar." : "タスクは新しいカレンダーに正常に移動されました。",
