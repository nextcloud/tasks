OC.L10N.register(
    ...
    "Create reminder" : "創建提醒",
    "Update reminder" : "更新提醒",
    "Set a reminder at a custom date and time:" : "在自訂日期和時間設置提醒：",
    "Cancel" : "取消",
    ...
    "Add reminder" : "添加提醒",
    "Before the task starts" : "任務開始前",
    "Before the task is due" : "任務截止前",
    "Select date and time" : "選擇日期與時間",
    "Go back" : "返回",
    "Do you want to keep related reminders?" : "您是否要保留相關提醒事項？",
    "Discard reminders" : "掉棄提醒",
    "Keep reminders" : "保留提醒",
    "Set a reminder relative to your tasks start date:" : "設置相對於任務開始日的提醒：",
    "Set a reminder relative to your tasks due date:" : "設置相對於任務到期日的提醒：",
    "before at" : "之前於",
    ...
    "November" : "十一月",
    "December" : "十二月",
    "on day {days}" : "在第 {days} 天",
    "on the {ordinal} {dayNames}" : "在 {ordinal} {dayNames} ",
    "in {months}" : "在 {months}",
    "_{count} time_::_{count} times_" : ["{count} 次"],
    "Completion date must be in the past." : "完成日期必須為過去的日期。",
    "Successfully created the task." : "成功創建了任務。",
    "Successfully duplicated the task." : "成功複製了任務。",
    "Could not duplicate the task." : "無法複製任務。",
    "Could not delete the task." : "無法刪除任務。",
    "Synchronizing to the server." : "與伺服器同步。",
    "Task successfully saved to server." : "任務已成功儲存到伺服器。",
    "Could not update the task because it was changed on the server. Please click to refresh it, local changes will be discarded." : "無法更新任務，因為其在伺服器上已變更。請點擊以重新整理，近端更新將會被掉棄。",
    "Could not update the task." : "無法更新任務。",
    "Successfully updated the task." : "成功更新了任務。",
    ...
    "[Due on] LL" : "[到期於] LL",
    "[Was due yesterday]" : "[於昨日到期]",
    "[Was due on] LL" : "[於] LL [到期]",
    "[Was due today at] LT" : "[於今日] LT [到期]",
    "[Due on] LL [at] LT" : "[於] LL LT [到期]",
    "[Was due yesterday at] LT" : "[已於昨天] LT [到期]",
    "[Was due on] LL [at] LT" : "[於] LL LT [到期]",
    "[Starts today]" : "[於今日開始]",
    "[Starts tomorrow]" : "[於明日開始]",
    "[Starts on] LL" : "[於] LL [開始]",
    "[Started yesterday]" : "[已於昨天開始]",
    "[Started on] LL" : "[已於] LL [開始]",
    "[Started today at] LT" : "[已於今日] LT [開始]",
    "[Starts today at] LT" : "[將於今日] LT [開始]",
    "[Starts tomorrow at] LT" : "[將於明日] LT [開始]",
    "[Starts on] LL [at] LT" : "[將於在] LL LT [開始]",
    "[Started yesterday at] LT" : "[已於昨天] LT [開始]",
    "[Started on] LL [at] LT" : "[已於] LL LT [開始]",
    "Midnight on the day the task starts" : "任務開始日的午夜",
    "_%n day before the task at {formattedHourMinute}_::_%n days before the task at {formattedHourMinute}_" : ["在 {formattedHourMinute} 任務前的 %n 天"],
    "_%n week before the task at {formattedHourMinute}_::_%n weeks before the task at {formattedHourMinute}_" : ["在 {formattedHourMinute} 任務前的 %n 星期"],
    "on the day of the task at {formattedHourMinute}" : "在 {formattedHourMinute} 任務的當天",
    "at the task's start" : "在任務開始時",
