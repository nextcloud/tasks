OC.L10N.register(
    ...
    "Show subtasks" : "顯示子任務",
    "Hide subtasks" : "隱藏子任務",
    "Show completed subtasks" : "顯示已完成的子任務",
    "Hide completed subtasks" : "隱藏已完成的子任務",
    "Delete task" : "刪除任務",
    ...
    "[Completed last] dddd [at] LT" : "[上次完成] L [於] LT",
    "[Completed] dddd [at] LT" : "[完成] dddd [於] LT",
    "[Completed] L" : "[完成] L",
    "[Last modified yesterday at] LT" : "[上次修改時間於] LT",
    "[Last modified today at] LT" : "[上次修改時間：今天] LT",
    "[Last modified] dddd [at] LT" : "[最後修改日期] dddd [於] LT",
    "[Last modified] L" : "[最後修改日期] L",
    "[Created yesterday at] LT" : "[昨天創建於] LT",
    "[Created today at] LT" : "[今天創建於] LT",
    "[Created] L" : "[ 已建立] L",
    "Needs action" : "需要採取行動 ",
    "In process" : "進行中",
    "Canceled" : "已取消",
