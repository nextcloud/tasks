OC.L10N.register(
    ...
    "Add a task to \"{task}\"…" : "新增工作項目到「{task}」……",
    ...
    "Last modified {date}" : "上次修改 {date}",
    "Created {date}" : "建立 {date}",
    "Completed {date}" : "已完成 {date}",
