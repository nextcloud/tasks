OC.L10N.register(
    ...
    "Do you really want to empty the trash bin?" : "Soll der Papierkorb geleert werden?",
    ...
    "Every {interval} {frequency}" : "Jeden {interval} {frequency}",
    "on {days}" : "an {days}",
    "until {date}" : "bis {date}",
    ...
    "Task is recurring" : "Wiederholende Aufgabe",
    ...
    "in {months}" : "in {months}",
    "_{count} time_::_{count} times_" : ["{count} mal","{count} mal"],
    ...
    "Successfully duplicated the task." : "Aufgabe wurde dupliziert.",
    "Could not duplicate the task." : "Aufgabe konnte nicht dupliziert werden.",
    ...
    "Error processing recurring task" : "Fehler beim Verarbeiten der wiederholenden Aufgabe",
