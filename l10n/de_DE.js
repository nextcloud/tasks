OC.L10N.register(
    ...
    "Deleted all completed tasks from calendar \"{calendarName}\"." : "Alle abgeschlossenen Aufgaben vom Kalender \"{calendarName}\" gelöscht.",
    "No errors" : "Keine Fehler",
    "Open your browser console for more details" : "Browser-Konsole für weitere Einzelheiten öffnen",
    "_This will delete {taskCount} completed task and its subtasks from calendar \"{calendarName}\"._::_This will delete {taskCount} completed tasks and their subtasks from calendar \"{calendarName}\"._" : ["Dies löscht {taskCount} abgeschlossene Aufgabe und ihre Unteraufgaben vom Kalender \"{calendarName}\".","Dies löscht {taskCount} abgeschlossene Aufgaben und ihre Unteraufgaben vom Kalender \"{calendarName}\"."],
