OC.L10N.register(
    ...
    "_This will delete {taskCount} completed task and its subtasks from calendar \"{calendarName}\"._::_This will delete {taskCount} completed tasks and their subtasks from calendar \"{calendarName}\"._" : ["Això esborrarà {taskCount} tasques completades i les seves subtasques del calendari \"{calendarName}\".","Això esborrarà {taskCount} tasques completades i les seves subtasques del calendari \"{calendarName}\"."],
    ...
    "Add a task due today to \"{calendar}\"…" : "Afegir un tasca per avui a \"{calendar}\"…",
    "Add a current task to \"{calendar}\"…" : "Afegir una tasca en curs a \"{calendar}\"…",
    "Add a task to \"{calendar}\"…" : "Afegeix una tasca a \"{calendar}\"...",
    "Tomorrow" : "Demà",
