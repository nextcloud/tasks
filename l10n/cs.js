OC.L10N.register(
    ...
    "Before the task starts" : "Před zahájením úkolu",
    "Before the task is due" : "Před termínem úkolu",
    "Select date and time" : "Vybrat datum a čas",
    "Go back" : "Jít zpět",
    "Do you want to keep related reminders?" : "Chcete ponechat související připomínky?",
    "Discard reminders" : "Zahodit připomínky",
    "Keep reminders" : "Ponechat připomínky",
    ...
    "Every {interval} {frequency}" : "Každé {interval} {frequency}",
    "on {days}" : "na {days}",
    "until {date}" : "do {date}",
    "{count} times" : "{count} krát",
    "Monday" : "pondělí",
    "Tuesday" : "úterý",
    "Wednesday" : "středa",
    "Thursday" : "čtvrtek",
    ...
    "Task is recurring" : "Úkol je opakující se",
    ...
    "November" : "listopad",
    "December" : "prosinec",
    "on day {days}" : "dne {days}",
    "on the {ordinal} {dayNames}" : "v {ordinal} {dayNames}",
    "in {months}" : "za {months}",
    "_{count} time_::_{count} times_" : ["{count} kát","{count} krát","{count} krát","{count} krát"],
    ...
    "Successfully duplicated the task." : "Úloha úspěšně zduplikována.",
    "Could not duplicate the task." : "Nebylo možné zduplikovat úkol.",
    ...
    "Error processing recurring task" : "Chyba při zpracovávání opakujícího se úkolu",
