...
"An empty name ist not allowed." => "Ein leerer Name ist nicht erlaubt.",
"Hidden" => "Verborgen",
"Visible" => "Sichtbar",
...
"1 Completed Task" => "Eine erledigte Aufgabe",
"Completed Tasks" => "Erledigte Aufgaben",
"Load more completed tasks" => "Weitere erledigte Aufgaben laden"
);
