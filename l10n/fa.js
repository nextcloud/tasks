OC.L10N.register(
    ...
    "Create reminder" : "ایجاد یادآور",
    "Update reminder" : "به‌روزرسانی یادآور",
    "Set a reminder at a custom date and time:" : "تنظیم یادآور در تاریخ و زمان دلخواه:",
    "Cancel" : "لغو",
    "This is a todo reminder." : "این یادآورِ یک کار است.",
    ...
    "Before the task starts" : "پیش از آغاز وظیفه",
    "Before the task is due" : "پیش از سررسید وظیفه",
    "Select date and time" : "انتخاب تاریخ و زمان",
    "Go back" : "برگرد",
    "Do you want to keep related reminders?" : "آیا می‌خواهید یادآورهای مرتبط را نگه دارید؟",
    "Discard reminders" : "صرف‌نظر از یادآورها",
    "Keep reminders" : "نگه‌داشتن یادآورها",
    "Set a reminder relative to your tasks start date:" : "تنظیم یادآور نسبت به تاریخ آغاز وظیفه‌تان:",
    "Set a reminder relative to your tasks due date:" : "تنظیم یادآور نسبت به تاریخ سررسید وظیفه‌تان:",
    "before at" : "قبل از در",
    ...
    "{numberOfTasks} tasks have been added to \"{calendar}\"" : "{numberOfTasks} وظیفه به \"{calendar}\" افزوده شد",
    "Create new tasks" : "ایجاد وظایف جدید",
    "Create {numberOfTasks} tasks from pasted text" : "ایجاد {numberOfTasks} وظیفه از متن جای‌گذاری‌شده",
    "Create tasks" : "ایجاد وظایف",
    "Creating new tasks…" : "در حال ایجاد وظایف جدید…",
    "Close" : "بسته",
    ...
    "Select tags to filter by" : "برچسب‌هایی را برای فیلتر کردن انتخاب کنید",
    ...
    "Loading the completed tasks might slow down the app." : "بارگیری وظایف تکمیل‌شده ممکن است برنامه را کند کند.",
    ...
    "Task is recurring" : "وظیفه تکرارشونده است",
    ...
    "Tomorrow" : "فردا",
    "An error occurred, unable to create the list." : "خطایی روی داد، لیست ایجاد نشد.",
    ...
    "Set a location" : "تعیین مکان",
    "Set a URL" : "تعیین نشانی اینترنتی",
    ...
    "Successfully duplicated the task." : "کار با موفقیت تکثیر شد.",
    "Could not duplicate the task." : "نمی‌توان کار را تکثیر کرد.",
    ...
    "Error processing recurring task" : "خطا در پردازش کار تکرارشونده",
    ...
    "Midnight on the day the task starts" : "نیمه‌شب روزی که وظیفه آغاز می‌شود",
    ...
    "on the day of the task at {formattedHourMinute}" : "در روز وظیفه، ساعت {formattedHourMinute}",
    "at the task's start" : "هنگام آغاز وظیفه",
    "when the task is due" : "هنگام سررسید وظیفه",
    "{time} before the task starts" : "{time} پیش از آغاز وظیفه",
    "{time} before the task is due" : "{time} پیش از سررسید وظیفه",
    "{time} after the task starts" : "{time} پس از آغاز وظیفه",
    "{time} after the task is due" : "{time} پس از موعد وظیفه"
},
