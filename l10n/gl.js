OC.L10N.register(
    ...
    "Deleted all completed tasks from calendar \"{calendarName}\"." : "Eliminadas todas as tarefas completadas do calendario «{calendarName}».",
    "No errors" : "Sen erros",
    "Open your browser console for more details" : "Abra a consola do navegador para obter máis detalles",
    "_This will delete {taskCount} completed task and its subtasks from calendar \"{calendarName}\"._::_This will delete {taskCount} completed tasks and their subtasks from calendar \"{calendarName}\"._" : ["Isto eliminará a tarefa completada de {taskCount} e as súas subtarefas do calendario «{calendarName}».","Isto eliminará as tarefas completadas de {taskCount} e as súas subtarefas do calendario «{calendarName}»."],
