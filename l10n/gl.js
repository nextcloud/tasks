OC.L10N.register(
    ...
    "Every {interval} {frequency}" : "Cada {interval} {frequency}",
    "on {days}" : "os {days}",
    "until {date}" : "ata {date}",
    ...
    "Task is recurring" : "A tarefa é recorrente",
    ...
    "Duplicate task" : "Tarefa duplicada",
    ...
    "November" : "novembro",
    "December" : "decembro",
    "on day {days}" : "o día {days}",
    "on the {ordinal} {dayNames}" : "o {ordinal} {dayNames}",
    "in {months}" : "en {months}",
    "_{count} time_::_{count} times_" : ["{count} vez","{count} veces"],
    ...
    "Successfully duplicated the task." : "A tarefa foi duplicada satisfactoriamente.",
    "Could not duplicate the task." : "Non foi posíbel duplicar a tarefa",
    ...
    "Error processing recurring task" : "Produciuse un erro ao procesar a tarefa",
