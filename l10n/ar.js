OC.L10N.register(
    ...
    "Filter by tags" : "فلترة بحسب السِّمات",
    ...
    "Sort by start date, priority and summary." : "الترتيب بحسب تاريخ البدء، و الأولوية، و المُلخّص.",
    "Due date" : "تاريخ الانجاز",
    "Sort by due date, priority and summary." : "الترتيب بحسب تاريخ الاستحقاق، و الأولوية، و المُلخّص.",
    "Created date" : "تاريخ الإنشاء",
    "Sort by created date, priority and summary." : "الترتيب بحسب تاريخ الإنشاء، و الأولوية، و المُلخّص.",
    "Last modified" : "آخر تعديل",
    "Sort by last-modified date, priority and summary." : "الترتيب بحسب آخر تعديل، و الأولوية، و المُلخّص.",
    "Completed date" : "تاريخ الإكتمال",
    "Sort by completed date, priority and summary." : "الترتيب بحسب تاريخ الاكتمال، و الأولوية، و المُلخّص.",
    "Priority" : "الأولوية",
    ...
    "Task has not yet started" : "مهمة لم تبدأ بعد",
    ...
    "Loading task from server." : "تحميل مهام من الخادوم",
    ...
    "Synchronizing to the server." : "مُزامنة الخادوم",
    "Task successfully saved to server." : "تمّ بنجاحٍ حفظ المهمة في الخادوم.",
    "Could not update the task because it was changed on the server. Please click to refresh it, local changes will be discarded." : "تعذّر تعديل المهمة بسبب أنه تمّ تغييرها على الخادوم. رجاءً، إضغط لتحديث العرض. التعديل الذي أجريته على جهازك سيتم تجاهله. ",
