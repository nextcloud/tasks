OC.L10N.register(
    ...
    "Go back" : "عودة",
    "Set a reminder relative to your tasks start date:" : "عيِّن تذكيراً نسبةً لتاريخ بداية المهام.",
    "Set a reminder relative to your tasks due date:" : "عيِّن تذكيراً نسبةً لتاريخ اكتمال المهام:",
    "before at" : "قبل",
    ...
    "On the" : "في الـ",
    "on" : "في",
    "On specific day" : "في يومٍ مُحدَّد",
    ...
    "November" : "نوفمبر",
    "December" : "ديسمبر",
    "on day {days}" : "في يوم {days}",
    "_{count} time_::_{count} times_" : ["{count} مرات","{count} مرة","{count} مرات","{count} مرات","{count} مرات","{count} مرات"],
