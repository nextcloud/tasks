OC.L10N.register(
    ...
    "found in task title." : "найдено в заголовке задачи.",
    "found in task note." : "найдено в примечании к задаче.",
    "found in task location." : "найдено в местоположении задачи.",
    "found in task categories." : "найдено в категориях задачи.",
    "found in task comments." : "найдено в комментариях к задаче.",
    "Due yesterday" : "Вчера",
    "Due today" : "Сегодня",
    "Due tomorrow" : "Завтра",
    "Due on" : "Срок",
