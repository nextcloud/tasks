OC.L10N.register(
    ...
    "Deleted all completed tasks from calendar \"%s\"." : "В календаре «%s» удалены все завершённые задачи.",
    ...
    "[Today]" : "[Сегодня]",
    "[Tomorrow]" : "[Завтра]",
    "Add a subtask to \"%s\"…" : "Добавить вложенную задачу в «%s»…",
    ...
    "Add an important task to \"%s\"…" : "Добавить в «%s» важную задачу…",
    "Add a task due today to \"%s\"…" : "Добавить в «%s» задачу на сегодня…",
    "Add a current task to \"%s\"…" : "Добавить в «%s» текущую задачу…",
    "Tomorrow" : "Завтра",
    ...
    "Priority %s: high" : "Приоритет %s: высокий",
    "Priority %s: medium" : "Приоритет %s: средний",
    "Priority %s: low" : "Приоритет %s: низкий",
    "%s %% completed" : "%s %% завершено",
    "Last modified %s" : "Изменено: %s",
    "Created %s" : "Создано: %s",
    "Completed %s" : "Завершено: %s",
    "Edit" : "Редактировать",
