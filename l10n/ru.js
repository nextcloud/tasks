OC.L10N.register(
    ...
    "Go back" : "Назад",
    "Do you want to keep related reminders?" : "Хотите сохранить связанные напоминания?",
    "Discard reminders" : "Отменить напоминания",
    "Keep reminders" : "Сохранить напоминания",
    ...
    "Every {interval} {frequency}" : "Каждые {interval} {frequency}",
    "on {days}" : "в {days}",
    "until {date}" : "до {date}",
    "{count} times" : "{count} раз",
    "Monday" : "Понедельник",
    "Tuesday" : "Вторник",
    "Wednesday" : "Среда",
    "Thursday" : "Четверг",
    ...
    "Task is recurring" : "Задача повторяется",
    ...
    "December" : "Декабрь",
    "on day {days}" : " {days}",
    "on the {ordinal} {dayNames}" : "в {ordinal} {dayNames}",
    "in {months}" : "в {months}",
    "_{count} time_::_{count} times_" : ["{count} раз","{count} раза","{count} раз","{count} раза"],
    "Completion date must be in the past." : "Дата завершения должна быть в прошлом.",
    "Successfully created the task." : "Задача создана.",
    "Successfully duplicated the task." : "Задача успешно продублирована.",
    "Could not duplicate the task." : "Не удалось дублировать задачу.",
    ...
    "Error processing recurring task" : "Ошибка обработки повторяющейся задачи",
