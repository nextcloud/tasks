OC.L10N.register(
    ...
    "Deleted all completed tasks from calendar \"%s\"." : "\"%s\" takviminden tüm tamamlanmış görevler silindi.",
    "No errors" : "Sorun yok",
    "Open your browser console for more details" : "Ayrıntılı bilgi almak için tarayıcı konsolonu açın",
    "_This will delete {taskCount} completed task and its subtasks from calendar \"%s\"._::_This will delete {taskCount} completed tasks and their subtasks from calendar \"%s\"._" : ["Bu işlem \"%s\" takviminden {taskCount} tamamlanmış görevi silecek.","Bu işlem \"%s\" takviminden {taskCount}  tamamlanmış görevi silecek."],
    ...
    "[Today]" : "[Bugün]",
    "[Tomorrow]" : "[Yarın]",
    "Add a subtask to \"%s\"…" : "\"%s\" takvimine bir alt görev ekle…",
    "Add a task to \"%s\"…" : "\"%s\" takvimine bir görev ekle…",
    "_%n Completed Task_::_%n Completed Tasks_" : ["%n Tamamlanmış Görev","%n Tamamlanmış Görev"],
    "Add an important task to \"%s\"…" : "\"%s\" takvimine önemli bir görev ekle…",
    "Add a task due today to \"%s\"…" : "\"%s\" takvimine bugün bitecek bir görev ekle…",
    "Add a current task to \"%s\"…" : "\"%s\" takvimine sürmekte olan bir görev ekle…",
    "Tomorrow" : "Yarın",
