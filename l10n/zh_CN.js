OC.L10N.register(
    ...
    "Deleted all completed tasks from calendar \"{calendarName}\"." : "从日历 \"{calendarName}\" 中删除所有已完成任务。",
    "No errors" : "没有错误",
    "Open your browser console for more details" : "打开您的浏览器控制台以获取更多详细信息",
    "_This will delete {taskCount} completed task and its subtasks from calendar \"{calendarName}\"._::_This will delete {taskCount} completed tasks and their subtasks from calendar \"{calendarName}\"._" : ["此操作将从日历 \"{calendarName}\" 中删除 {taskCount} 个已完成任务及其子任务。"],
