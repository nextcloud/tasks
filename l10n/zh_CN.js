OC.L10N.register(
    ...
    "Deleted all completed tasks from calendar \"%s\"." : "从日历 \"%s\" 中删除所有已完成任务。",
    "No errors" : "没有错误",
    ...
    "Add a task to \"%s\"…" : "添加任务到 \"%s\" ...",
    "_%n Completed Task_::_%n Completed Tasks_" : ["%n 任务完成"],
    "Add an important task to \"%s\"…" : "添加重要任务到 \"%s\" ...",
    "Add a task due today to \"%s\"…" : "添加今天截止的任务到 \"%s\" ...",
    "Add a current task to \"%s\"…" : "添加当前任务到 \"%s\" ...",
    "Tomorrow" : "明天",
