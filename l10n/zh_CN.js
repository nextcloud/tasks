OC.L10N.register(
    ...
    "_Shared with {num} entity_::_Shared with {num} entities_" : ["已与 {num} 个实体共享"],
    ...
    "Set a reminder at a custom date and time:" : "在自定义日期和时间设置提醒：",
    "Cancel" : "取消",
    "This is a todo reminder." : "这是待办事项提醒。",
    "No reminders" : "无提醒",
    "Notification" : "通知",
    "Email" : "电子邮箱",
    ...
    "Add reminder" : "添加提醒",
    "Before the task starts" : "任务开始前",
    "Before the task is due" : "任务截止前",
    "Select date and time" : "选择日期和时间",
    "Go back" : "返回",
    "Do you want to keep related reminders?" : "是否要保留相关提醒？",
    "Discard reminders" : "舍弃提醒",
    "Keep reminders" : "保留提醒",
    "Set a reminder relative to your tasks start date:" : "设置与任务开始日期相关的提醒：",
    "Set a reminder relative to your tasks due date:" : "设置与任务截止日期相关的提醒：",
    "before at" : "在此之前：",
    ...
    "_Task has one reminder_::_Task has {n} reminders_" : ["任务有 {n} 个提醒"],
    ...
    "Tomorrow" : "明天",
    "An error occurred, unable to create the list." : "发生错误，无法创建列表。",
    "Add List…" : "添加列表 ...",
    "New list" : "新列表",
    ...
    "[Completed] L" : "[完成于] L",
    "[Completed last] dddd [at] LT" : "[完成于上] dddd LT",
    "[Completed] dddd [at] LT" : "[完成于] dddd LT",
    "[Last modified yesterday at] LT" : "[最后修改于昨天] LT",
    "[Last modified today at] LT" : "[最后修改于今天] LT",
    "[Last modified] L" : "[最后修改于] L",
    "[Last modified last] dddd [at] LT" : "[最后修改于上] dddd LT",
    "[Last modified] dddd [at] LT" : "[最后修改于] dddd LT",
    "[Created yesterday at] LT" : "[创建于昨天] LT",
    "[Created today at] LT" : "[创建于今天] LT",
    "[Created] L" : "[创建于] L",
    "[Created last] dddd [at] LT" : "[创建于上] dddd LT",
    "[Created] dddd [at] LT" : "[创建于] dddd LT",
    "Needs action" : "需要操作",
    "In process" : "处理中",
    "Canceled" : "已取消",
    "Clear status" : "清除日期",
    ...
    "Completion date must be in the past." : "完成日期必须在过去。",
    "Successfully created the task." : "成功创建任务。",
    "Successfully duplicated the task." : "已成功复制任务。",
    "Could not duplicate the task." : "无法复制任务。",
    "Could not delete the task." : "无法删除任务。",
    "Synchronizing to the server." : "正在同步到服务器。",
    "Task successfully saved to server." : "任务已成功保存到服务器。",
    "Could not update the task because it was changed on the server. Please click to refresh it, local changes will be discarded." : "无法更新任务，因为它已在服务器上更改。请点击刷新，本地更改将被舍弃。",
    "Could not update the task." : "无法更新任务。",
    "Successfully updated the task." : "成功更新任务。",
    "Error processing recurring task" : "处理重复任务时出错",
    ...
    "Midnight on the day the task starts" : "任务开始当天午夜",
    "_%n day before the task at {formattedHourMinute}_::_%n days before the task at {formattedHourMinute}_" : ["在 {formattedHourMinute} 任务的 %n 天前"],
    "_%n week before the task at {formattedHourMinute}_::_%n weeks before the task at {formattedHourMinute}_" : ["在 {formattedHourMinute} 任务的 %n 周前"],
    "on the day of the task at {formattedHourMinute}" : "在 {formattedHourMinute} 任务的当天",
    "at the task's start" : "在任务开始时",
    "when the task is due" : "当任务截止时",
    "{time} before the task starts" : "在任务开始前 {time}",
    "{time} before the task is due" : "在任务截止前 {time}",
    "{time} after the task starts" : "在任务开始后 {time}",
    "{time} after the task is due" : "在任务截止后 {time}"
},
"nplurals=1; plural=0;");
