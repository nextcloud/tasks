OC.L10N.register(
    ...
    "Once enabled, a new Tasks menu will appear in your Nextcloud apps menu. From there you can add and delete tasks, edit their title, description, start and due dates, reminder times, mark them as important, and add comments on them. Tasks can be shared between users. Tasks can be synchronized using CalDav (each task list is linked to an Nextcloud calendar, to sync it to your local client - Thunderbird, Evolution, KDE Kontact, iCal... - just add the calendar as a remote calendar in you client). You can download your tasks as ICS files using the download button for each calendar." : "启用后，Nextcloud应用菜单中将显示一个新的“任务”菜单。 从那里，您可以添加和删除任务，编辑其标题，描述，开始和截止日期，提醒时间，将其标记为重要，并添加注释。 任务可以在用户之间共享。 可以使用CalDav同步任务（每个任务列表链接到Nextcloud日历，将其同步到本地客户端 - Thunderbird，Evolution，KDE Kontact，iCal ...... - 只需将日历添加为客户端中的远程日历）。 您可以使用每个日历的下载按钮将任务下载为ICS文件。",
    "Delete" : "删除",
    "Cancel" : "取消",
    "Edit" : "编辑",
    "Link" : "链接",
