OC.L10N.register(
    ...
    "Every {interval} {frequency}" : "Every {interval} {frequency}",
    "on {days}" : "on {days}",
    ...
    "Task is recurring" : "Task is recurring",
    ...
    "on the {ordinal} {dayNames}" : "on the {ordinal} {dayNames}",
    "in {months}" : "in {months}",
    "_{count} time_::_{count} times_" : ["{count} time","{count} times"],
    ...
    "Successfully duplicated the task." : "Successfully duplicated the task.",
    "Could not duplicate the task." : "Could not duplicate the task.",
    ...
    "Error processing recurring task" : "Error processing recurring task",
