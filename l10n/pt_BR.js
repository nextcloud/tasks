OC.L10N.register(
    ...
    "Deleted all completed tasks from calendar \"{calendarName}\"." : "Excluídas todas as tarefas concluídas do calendário \"{calendarName}\".",
    "No errors" : "Sem erros",
    "Open your browser console for more details" : "Abra o console do navegador para mais detalhes",
    "_This will delete {taskCount} completed task and its subtasks from calendar \"{calendarName}\"._::_This will delete {taskCount} completed tasks and their subtasks from calendar \"{calendarName}\"._" : ["Isso excluirá {taskCount} tarefa concluída e suas subtarefas do calendário \"{calendarName}\".","Isso excluirá {taskCount} tarefas concluídas e suas subtarefas do calendário \"{calendarName}\"."],
