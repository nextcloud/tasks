OC.L10N.register(
    ...
    "Go back" : "Voltar",
    "Set a reminder relative to your tasks start date:" : "Defina um lembrete relativo à data de início de sua tarefa:",
    "Set a reminder relative to your tasks due date:" : "Defina um lembrete relativo à data de vencimento de sua tarefa:",
    "before at" : "antes das",
    ...
    "Create new tasks" : "Crie novas tarefas",
    "Create {numberOfTasks} tasks from pasted text" : "Crie tarefas {numberOfTasks} a partir do texto colado",
    ...
    "Loading the completed tasks of all lists might slow down the app." : "Carregar as tarefas concluídas de todas as listas podem tornar o aplicativo lento.",
    ...
    "_%n day before the task at {formattedHourMinute}_::_%n days before the task at {formattedHourMinute}_" : ["%n dia antes da tarefa, às {formattedHourMinute}","%n dias antes da tarefa, às {formattedHourMinute}","%ndias antes da tarefa, às {formattedHourMinute}"],
