OC.L10N.register(
    ...
    "_Deleting the list in {countdown} second_::_Deleting the list in {countdown} seconds_" : ["Διαγραφή λίστας σε {countdown} δεύτερα","Διαγραφή λίστας σε {countdown} δεύτερα"],
    "_Unsharing the list in {countdown} second_::_Unsharing the list in {countdown} seconds_" : ["Κατάργηση κοινής χρήσης λίστας σε {countdown} δεύτερα","Κατάργηση κοινής χρήσης λίστας σε {countdown} δεύτερα"],
    ...
    "L [at] LT" : "L [στις] LT",
    "[Completed yesterday at] LT" : "[Ολοκληρώθηκε εχθές στις] LT",
    ...
    "When shared show only busy" : "Προβολή απασχολημένων, όταν κοινοποιείται",
    "When shared hide this event" : "Απόκρυψη, όταν κοινοποιείται",
    ...
    "No priority assigned" : "Ορίστε προτεραιότητα",
