OC.L10N.register(
    ...
    "Deleted all completed tasks from calendar \"%s\"." : "Usunięto wszystkie zakończone zadania z kalendarza \"%s\".",
    ...
    "_This will delete {taskCount} completed task and its subtasks from calendar \"%s\"._::_This will delete {taskCount} completed tasks and their subtasks from calendar \"%s\"._" : ["Spowoduje to usunięcie {taskCount} zakończonego zadania i jego podzadań z kalendarza \"%s\".","Spowoduje to usunięcie {taskCount} zakończonych zadań i ich podzadań z kalendarza \"%s\".","Spowoduje to usunięcie {taskCount} zakończonych zadań i ich podzadań z kalendarza \"%s\".","Spowoduje to usunięcie {taskCount} zakończonych zadań i ich podzadań z kalendarza \"%s\"."],
    ...
    "Add a task to \"%s\"…" : "Dodaj zadanie do \"%s\"…",
    ...
    "Add an important task to \"%s\"…" : "Dodaj ważne zadanie do \"%s\"…",
    "Add a task due today to \"%s\"…" : "Dodaj ważne zadanie do dzisiaj \"%s\"…",
    "Add a current task to \"%s\"…" : "Dodaj bieżące zadanie do \"%s\"…",
    "Tomorrow" : "Jutro",
