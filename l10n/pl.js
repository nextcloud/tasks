OC.L10N.register(
    ...
    "Create reminder" : "Utwórz przypomnienie",
    "Update reminder" : "Zaktualizuj przypomnienie",
    "Set a reminder at a custom date and time:" : "Ustaw przypomnienie na niestandardową datę i godzinę:",
    "Cancel" : "Anuluj",
    "This is a todo reminder." : "To jest przypomnienie o zadaniu.",
    ...
    "Before the task starts" : "Przed rozpoczęciem zadania",
    "Before the task is due" : "Przed terminem realizacji zadania",
    "Select date and time" : "Wybierz datę i godzinę",
    "Go back" : "Wstecz",
    "Do you want to keep related reminders?" : "Czy chcesz zachować powiązane przypomnienia?",
    "Discard reminders" : "Odrzuć przypomnienia",
    "Keep reminders" : "Zachowaj przypomnienia",
    "Set a reminder relative to your tasks start date:" : "Ustaw przypomnienie względem daty rozpoczęcia zadania:",
    "Set a reminder relative to your tasks due date:" : "Ustaw przypomnienie względem terminu wykonania zadania:",
    "before at" : "przed",
    ...
    "Every {interval} {frequency}" : "Co {interval} {frequency}",
    "on {days}" : "w {days}",
    "until {date}" : "do {date}",
    "{count} times" : "{count} razy",
    "Monday" : "Poniedziałek",
    "Tuesday" : "Wtorek",
    "Wednesday" : "Środa",
    "Thursday" : "Czwartek",
    ...
    "Loading the completed tasks might slow down the app." : "Wczytywanie ukończonych zadań może spowolnić działanie aplikacji.",
    ...
    "Tags" : "Etykiety",
    "Sort by tags." : "Sortuj według tagów.",
    "Manually" : "Ręcznie",
    ...
    "Task is recurring" : "Zadanie jest cykliczne",
    ...
    "Duplicate task" : "Duplikuj zadanie",
    "Delete task" : "Usuń zadanie",
    "Toggle starred" : "Oznaczono gwiazdką",
    "_Task has one reminder_::_Task has {n} reminders_" : ["Zadanie ma jedno przypomnienie","Zadanie ma {n} przypomnienia","Zadanie ma {n} przypomnień","Zadanie ma {n} przypomnień"],
    ...
    "Tomorrow" : "Jutro",
    "An error occurred, unable to create the list." : "Wystąpił błąd, nie udało się utworzyć listy.",
    ...
    "Show in Deck" : "Pokaż w Deck",
    "Edit summary" : "Edytuj podsumowanie",
    "Details" : "Szczegóły",
    ...
    "Set a location" : "Ustaw lokalizację",
    "Set a URL" : "Ustaw URL",
    ...
    "November" : "Listopad",
    "December" : "Grudzień",
    "on day {days}" : "w dzień {days}",
    "on the {ordinal} {dayNames}" : "w {ordinal} {dayNames}",
    "in {months}" : "w {months}",
    "_{count} time_::_{count} times_" : ["{count} raz","{count} razy","{count} razy","{count} razy"],
    "Completion date must be in the past." : "Data zakończenia musi być w przeszłości.",
    "Successfully created the task." : "Pomyślnie utworzono zadanie.",
    "Successfully duplicated the task." : "Zadanie zostało pomyślnie zduplikowane",
    "Could not duplicate the task." : "Nie udało się zduplikować zadania",
    ...
    "Error processing recurring task" : "Błąd podczas przetwarzania zadania cyklicznego",
    ...
    "Midnight on the day the task starts" : "Północ w dniu rozpoczęcia zadania",
    "_%n day before the task at {formattedHourMinute}_::_%n days before the task at {formattedHourMinute}_" : ["1 dzień przed rozpoczęciem zadania o {formattedHourMinute}","%n dni przed rozpoczęciem zadania o {formattedHourMinute}","%n dni przed rozpoczęciem zadania o {formattedHourMinute}","%n dni przed rozpoczęciem zadania o {formattedHourMinute}"],
    "_%n week before the task at {formattedHourMinute}_::_%n weeks before the task at {formattedHourMinute}_" : ["%n tydzień przed rozpoczęciem zadania o {formattedHourMinute}","%n tygodnie przed rozpoczęciem zadania o {formattedHourMinute}","%n tygodni przed rozpoczęciem zadania o {formattedHourMinute}","%n tygodni przed rozpoczęciem zadania o {formattedHourMinute}"],
    "on the day of the task at {formattedHourMinute}" : "w dniu rozpoczęcia zadania o {formattedHourMinute}",
    "at the task's start" : "na początku zadania",
    "when the task is due" : "w momencie terminu realizacji zadania",
    "{time} before the task starts" : "{time} przed rozpoczęciem zadania",
    "{time} before the task is due" : "{time} przed terminem wykonania zadania",
    "{time} after the task starts" : "{time} po rozpoczęciu zadania",
    "{time} after the task is due" : "{time} po terminie wykonania zadania"
},
