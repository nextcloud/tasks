OC.L10N.register(
    ...
    "Deleted all completed tasks from calendar \"{calendarName}\"." : "Þetta mun eyða öllum loknum verkefnum úr dagatalinu \"{calendarName}\".",
    ...
    "_This will delete {taskCount} completed task and its subtasks from calendar \"{calendarName}\"._::_This will delete {taskCount} completed tasks and their subtasks from calendar \"{calendarName}\"._" : ["Þetta mun eyða {taskCount} loknu verkefni og undirverkefnum þess úr dagatalinu \"{calendarName}\".","Þetta mun eyða {taskCount} loknum verkefnum og undirverkefnum þeirra úr dagatalinu \"{calendarName}\"."],
