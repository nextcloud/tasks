OC.L10N.register(
    ...
    "Update reminder" : "Оновити нагадування",
    "Set a reminder at a custom date and time:" : "Встановити нагадування на визначену дату та час:",
    "Cancel" : "Скасувати",
    "This is a todo reminder." : "Це нагадування для виконання дії.",
    ...
    "Before the task starts" : "До початку завдання",
    "Before the task is due" : "Перед завершенням завдання",
    "Select date and time" : "Вибрати дату та час",
    "Go back" : "Повернутися назад",
    "Do you want to keep related reminders?" : "Чи ви бажаєте зберегти дотичні нагадування?",
    "Discard reminders" : "Скасувати нагадування",
    "Keep reminders" : "Зберегти нагадування",
    "Set a reminder relative to your tasks start date:" : "Встановити нагадування залежно від дати початку завдання:",
    "Set a reminder relative to your tasks due date:" : "Встановити нагадування залежно від дати виконання завдання:",
    "before at" : "до о",
    ...
    "Every {interval} {frequency}" : "Кожні {interval} {frequency}",
    "on {days}" : "у {days}",
    "until {date}" : "до {date}",
    "{count} times" : "{count} рази",
    "Monday" : "Понеділок",
    "Tuesday" : "Вівторок",
    "Wednesday" : "Середа",
    "Thursday" : "Четвер",
    ...
    "Repeat task" : "Повторювати завдання",
    "Save" : "Зберегти",
    "Set value" : "Встановити значення",
    "Delete value" : "Очистити значення",
    ...
    "Tags" : "Мітки",
    "Sort by tags." : "Впорядковувати за мітками.",
    "Manually" : "Вручну",
    ...
    "Task is recurring" : "Повторюване завдання",
    ...
    "Duplicate task" : "Копіювати завдання",
    ...
    "November" : "Листопад",
    "December" : "Грудень",
    "on day {days}" : "у наступний день {days}",
    "on the {ordinal} {dayNames}" : "у {ordinal} {dayNames}",
    "in {months}" : "у {months}",
    "_{count} time_::_{count} times_" : ["{count} раз","{count} разів","{count} разів","{count} рази"],
    ...
    "Successfully duplicated the task." : "Створено копію завдання.",
    "Could not duplicate the task." : "Не вдалося створити копію завдання.",
    ...
    "Error processing recurring task" : "Помилка під час обробки повторюваного завдання",
    ...
    "Midnight on the day the task starts" : "Опівночі у день початку завдання",
    "_%n day before the task at {formattedHourMinute}_::_%n days before the task at {formattedHourMinute}_" : ["%n день перед початком завдання о {formattedHourMinute}","%n дні перед початком завдання о {formattedHourMinute}","%n днів перед початком завдання о {formattedHourMinute}","%n днів перед початком завдання о {formattedHourMinute}"],
    "_%n week before the task at {formattedHourMinute}_::_%n weeks before the task at {formattedHourMinute}_" : ["%n тиждень перед початком завдання о {formattedHourMinute}","%n тижня перед початком завдання о {formattedHourMinute}","%n тижнів перед початком завдання о {formattedHourMinute}","%n тижнів перед початком завдання о {formattedHourMinute}"],
    "on the day of the task at {formattedHourMinute}" : "у день виконання завдання о {formattedHourMinute}",
    "at the task's start" : "перед початком завдання",
    "when the task is due" : "після дати завершення завдання",
    "{time} before the task starts" : "{time} перед початком завдання",
    "{time} before the task is due" : "{time} перед завершенням завдання",
    "{time} after the task starts" : "{time} після початку завдання",
    "{time} after the task is due" : "{time} після завершення завдання"
},
