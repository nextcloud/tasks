OC.L10N.register(
    ...
    "Create reminder" : "Creëer herinnering",
    "Update reminder" : "Werk herinnering bij",
    "Set a reminder at a custom date and time:" : "Zet een herinnering op een aangepaste datum en tijd:",
    "Cancel" : "Annuleren",
    "This is a todo reminder." : "Dit is een to-do herinnering",
    "No reminders" : "Geen herinneringen",
    "Notification" : "Melding",
    "Email" : "E-mail",
    "Audio notification" : "Audio melding",
    "Other notification" : "Andere melding",
    "Edit time" : "Bewerk de tijd",
    "Remove reminder" : "Verwijder herinnering",
    "Add reminder" : "Voeg herinnering toe",
    "Before the task starts" : "Voor de taak start",
    "Before the task is due" : "Voordat de taak verloopt",
    "Select date and time" : "Selecteer datum en tijd",
    "Go back" : "Ga terug",
    "Do you want to keep related reminders?" : "Wil je gerelateerde herinneringen bewaren?",
    "Discard reminders" : "Negeer herinneringen",
    "Keep reminders" : "Bewaar herinneringen",
    "Set a reminder relative to your tasks start date:" : "Stel een herinnering in ten opzichte van de start datum van je taak:",
    "Set a reminder relative to your tasks due date:" : "Stel een herinnering in ten opzichte van de start vervaldatum van je taak:",
    "before at" : "ervoor om",
    ...
    "Every {interval} {frequency}" : "Elke {interval} {frequency}",
    "on {days}" : "op {days}",
    "until {date}" : "tot {date}",
    "{count} times" : "{count} keer",
    "Monday" : "maandag",
    "Tuesday" : "dinsdag",
    "Wednesday" : "woensdag",
    "Thursday" : "donderdag",
    ...
    "{numberOfTasks} tasks have been added to \"{calendar}\"" : "{numberOfTasks} taken zijn toegevoegd aan \"{calendar}\"",
    "Create new tasks" : "Creëer nieuwe taken",
    "Create {numberOfTasks} tasks from pasted text" : "Creëer {numberOfTasks} taken van geplakte tekst",
    "Create tasks" : "Creëer taken",
    "Creating new tasks…" : "Nieuwe taken worden gecreëerd ...",
    "Close" : "Sluiten",
    ...
    "Load the completed tasks of all lists." : "Laad de afgeronde taken van alle lijsten.",
    ...
    "Load the completed tasks of list \"{calendar}\"." : "Laad de afgeronde taken van lijst \"{calendar}\".",
    "Loading the completed tasks might slow down the app." : "Het laden van afgeronde taken kan de app vertragen",
    ...
    "On the" : "Op de",
    "on" : "op",
    "On specific day" : "Op specifieke dag",
    "weekday" : "weekdag",
    ...
    "Task is recurring" : "Taak is herhalend",
    ...
    "Duplicate task" : "Dubbele taak",
    "Delete task" : "Verwijder taak",
    "Toggle starred" : "Omschakelen gesterd",
    "_Task has one reminder_::_Task has {n} reminders_" : ["Taak heeft één herinnering","Taak heeft {n} herinneringen"],
    ...
    "Tomorrow" : "Morgen",
    "An error occurred, unable to create the list." : "Er is een probleem, kan lijst niet maken",
    ...
    "Show in Deck" : "Laat zien in Deck",
    "Edit summary" : "Bewerk samenvatting",
    "Details" : "Details",
    ...
    "Set a location" : "Zet een locatie",
    "Set a URL" : "Zet een URL",
    ...
    "November" : "November",
    "December" : "December",
    "on day {days}" : "op dag {days}",
    "on the {ordinal} {dayNames}" : "op de {ordinal} {dayNames}",
    "in {months}" : "binnen {months}",
    "_{count} time_::_{count} times_" : ["{count} keer","{count} keer"],
    "Completion date must be in the past." : "Datum van afronding moet in het verleden liggen",
    "Successfully created the task." : "Taak succesvol aangemaakt",
    "Successfully duplicated the task." : "Taak succesvol gedupliceerd",
    "Could not duplicate the task." : "Kan taak niet dupliceren",
    ...
    "Error processing recurring task" : "Probleem met verwerken van herhalende taak",
    ...
    "Midnight on the day the task starts" : "Middernacht op de dag dat de taak start",
    "_%n day before the task at {formattedHourMinute}_::_%n days before the task at {formattedHourMinute}_" : ["%n dag voor de taak om {formattedHourMinute}","%n dagen voor de taak om {formattedHourMinute}"],
    "_%n week before the task at {formattedHourMinute}_::_%n weeks before the task at {formattedHourMinute}_" : ["%n week voor de taak om {formattedHourMinute}","%n weken voor de taak om {formattedHourMinute}"],
    "on the day of the task at {formattedHourMinute}" : "op de dag van de taak om {formattedHourMinute}",
    "at the task's start" : "als de taak start",
    "when the task is due" : "als de taak verloopt",
    "{time} before the task starts" : "{time} voordat de taak start",
    "{time} before the task is due" : "{time} voordat de taak vervalt",
    "{time} after the task starts" : "{time} nadat de taak gestart is",
    "{time} after the task is due" : "{time} nadat de taak is vervallen"
},
