...
"Current" => "現在",
"Completed" => "完了",
"found in task title." => "タスクのタイトルがあります。",
"found in task note." => "タスクのメモがあります。",
"found in task location." => "タスクの場所があります。",
"found in task categories." => "タスクのカテゴリがあります。",
"found in task comments." => "タスクのコメントがあります。",
"Due yesterday" => "昨日まで",
"Due today" => "今日まで",
"Due tomorrow" => "明日まで",
"Due on" => "期日",
...
"Completed Task" => "完了済みタスク",
"%n Completed Task::%n Completed Tasks" => array("完了済みタスク %n"),
"Set due date" => "期限を設定",
"%s %% completed" => "%s %% 完了",
"Remind me" => "リマインド",
"at the end" => "終了時",
