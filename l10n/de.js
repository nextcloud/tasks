OC.L10N.register(
    ...
    "This will unshare the list \"{list}\"." : "Die Freigabe der Liste \"{list}\" wird aufgehoben.",
    ...
    "_Deleting the list in {countdown} second_::_Deleting the list in {countdown} seconds_" : ["Lösche die Liste in {countdown} Sekunde","Lösche die Liste in {countdown} Sekunden"],
    ...
    "_Shared with {num} entity_::_Shared with {num} entities_" : ["Für {num} Entitäten freigegeben","Für {num} Entität freigegeben"],
