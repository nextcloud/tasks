OC.L10N.register(
    ...
    "Deleted all completed tasks from calendar \"%s\"." : "Обрисани сви завршени задаци из календара „%s“.",
    "No errors" : "Нема грешака",
    "Open your browser console for more details" : "Отворите конзолу веб читача за више детаља",
    "_This will delete {taskCount} completed task and its subtasks from calendar \"%s\"._::_This will delete {taskCount} completed tasks and their subtasks from calendar \"%s\"._" : ["Ово ће обрисати {taskCount} завршени задатак и све њихове подзадатке из календара „%s“. ","Ово ће обрисати {taskCount} завршенa задатка и све њихове подзадатке из календара „%s“. ","Ово ће обрисати {taskCount} завршених задатака и све њихове подзадатке из календара „%s“."],
    ...
    "[Today]" : "[Данас]",
    "[Tomorrow]" : "[Сутра]",
    "Add a subtask to \"%s\"…" : "Додај подзадатак на „%s“…",
    "Add a task to \"%s\"…" : "Додај задатак на „%s“…",
    "_%n Completed Task_::_%n Completed Tasks_" : ["%n завршен задатак","%n завршена задатка","%n завршених задатака"],
    "Add an important task to \"%s\"…" : "Додај важан задатак на „%s“…",
    "Add a task due today to \"%s\"…" : "Додај задатак са роком за данас на „%s“…",
    "Add a current task to \"%s\"…" : "Додај тренутни задатак на „%s“…",
    "Tomorrow" : "сутра",
    ...
    "Priority %s: high" : "Приоритет %s: висок",
    "Priority %s: medium" : "Приоритет %s: средњи",
    "Priority %s: low" : "Приоритет %s: мали",
