OC.L10N.register(
    ...
    "Deleted all completed tasks from calendar \"{calendarName}\"." : "Обриши све завршене задатке из календара „{calendarName}“.",
    "No errors" : "Нема грешака",
    "Open your browser console for more details" : "Отворите конзолу веб читача за више детаља",
    "_This will delete {taskCount} completed task and its subtasks from calendar \"{calendarName}\"._::_This will delete {taskCount} completed tasks and their subtasks from calendar \"{calendarName}\"._" : ["Ово ће обрисати {taskCount} завршени задатак и све његове подзадатке из календара „{calendarName}“.","Ово ће обрисати {taskCount} завршена задатка и све њихове подзадатке из календара „{calendarName}“.","Ово ће обрисати {taskCount} завршених задатака и све њихове подзадатке из календара „{calendarName}“."],
